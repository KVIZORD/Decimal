...
int double_decimal_to_decimal(s21_double_decimal src, s21_decimal* dst) {
  ...
  while (exp < 2 * EXP_MAX &&
    ...
    div_double_decimal_with_remainder(src,
                                      (s21_double_decimal){{
                                          10,
                                          0,
                                      }},
...
int normalization_double_decimal(s21_double_decimal* value_1,
  ...
  for (; exp_1 > exp_2; exp_2++) {
    mul_double_decimal(
        *value_2, (s21_double_decimal){{10, 0, 0, 0, 0, 0, 1 << BIT_EXP_START}},
        value_2);
  }
  for (; exp_1 < exp_2; exp_1++) {
    mul_double_decimal(
        *value_1, (s21_double_decimal){{10, 0, 0, 0, 0, 0, 1 << BIT_EXP_START}},
        value_1);
  }
